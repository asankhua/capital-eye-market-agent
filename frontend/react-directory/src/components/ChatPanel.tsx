          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', height: '100%' }}>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '8px' }}>NIFTY 50</p>
                <p style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a' }}>24,150.45</p>
                <p style={{ fontSize: '14px', color: '#059669', fontWeight: 600 }}>+125.80 (+0.52%)</p>
              </div>
              <div style={{
                padding: '20px',
                background: '#ffffff',
                ...
                <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '8px' }}>SENSEX</p>
                <p style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a' }}>79,234.56</p>
                <p style={{ fontSize: '14px', color: '#059669', fontWeight: 600 }}>+312.45 (+0.40%)</p>
              </div>
              <div style={{
                padding: '20px',
                background: '#ffffff',
                ...
                <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '8px' }}>NIFTY Bank</p>
                <p style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a' }}>48,234.78</p>
                <p style={{ fontSize: '14px', color: '#dc2626', fontWeight: 600 }}>-89.12 (-0.18%)</p>
              </div>
              <div style={{
                padding: '20px',
                background: '#ffffff',
                ...
                <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '8px' }}>NIFTY Midcap 150</p>
                <p style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a' }}>16,842.35</p>
                <p style={{ fontSize: '14px', color: '#059669', fontWeight: 600 }}>+98.45 (+0.59%)</p>
              </div>
              {/* NSE Market Tile */}
              <div style={{
                padding: '20px',
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                  <p style={{ fontSize: '13px', color: '#64748b' }}>NSE</p>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    ...
                    <span style={{ fontSize: '11px', color: '#10b981', fontWeight: 600 }}>Open</span>
                  </div>
                </div>
                <p style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a' }}>22,456.30</p>
                <p style={{ fontSize: '14px', color: '#10b981', fontWeight: 600 }}>+0.45%</p>
              </div>
            </div>
